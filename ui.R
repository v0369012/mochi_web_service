  ...
  fluidPage(
      ...
      tabPanel(title = span("Tutorial", style = tabPanel_title_style),
               ...
               mainPanel(
                 ...
                 tags$iframe(style="height: 800px; width:90%; scrolling=yes;margin:0 100px", id = "ch2",
                             src=paste0("https://mochi.life.nctu.edu.tw/MOCHI_Tutorial_Web_20210702.pdf")
    ...
    tags$footer(
      tags$span(
        ...
        " National Yang Ming Chiao Tung University, Taiwan 300, R.O.C.,", " last updated on 07/08/2021"),
